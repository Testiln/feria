  ...
  return (
    <div className="font-sans bg-white overflow-x-hidden selection:bg-[#C62828] selection:text-white fade-in">
      <header className="absolute top-0 left-0 w-full p-6 z-50 flex justify-between items-center">
        <div className="text-white font-montserrat font-black text-3xl tracking-tighter drop-shadow-md lg:-translate-y-4">
          jamar<span className="text-sm align-top">®</span>
        </div>
        <div className="hidden lg:block h-4 w-full"></div>
      </header>

      <section className="relative w-full min-h-[100svh] bg-[#C62828] flex items-center justify-center overflow-hidden px-6 lg:px-20 pt-24 pb-20 lg:pt-20 lg:pb-12">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center lg:-mt-4">
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left fade-in w-full order-2 lg:order-1">
            ...
            <div className="bg-[#8E1C1C] border-l-8 border-white p-2.5 md:p-3 mb-8 transform -skew-x-3 shadow-2xl mx-auto lg:mx-0">
              <h3 className="font-montserrat font-black text-white text-2xl md:text-3xl uppercase tracking-tighter">Extra Cupo</h3>
            </div>
          ...
          <div className="hidden lg:block relative fade-in order-3 lg:order-2 lg:absolute lg:right-0 lg:top-1/2 lg:transform lg:-translate-y-1/2 lg:w-1/2">
            <img
              src="/landing1.png"
              alt="Muebles nuevos Jamar"
              className="w-[175%] max-w-none h-auto object-contain object-center drop-shadow-2xl absolute top-1/2 -translate-y-[55%] translate-x-[-15%]"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#F5F5F5] p-8 rounded-3xl text-center hover:-translate-y-2 transition-transform duration-300 shadow-lg border border-gray-100">
              ...
              <h3 className="font-poppins font-bold text-xl text-gray-900 mb-4 uppercase">Crédito sin intereses</h3>
            ...
            <div className="bg-[#F5F5F5] p-8 rounded-3xl text-center hover:-translate-y-2 transition-transform duration-300 shadow-lg border border-gray-100">
              ...
              <h3 className="font-poppins font-bold text-xl text-gray-900 mb-4 uppercase">Productos nuevos</h3>
            ...
            <div className="bg-[#F5F5F5] p-8 rounded-3xl text-center hover:-translate-y-2 transition-transform duration-300 shadow-lg border border-gray-100">
              ...
              <h3 className="font-poppins font-bold text-xl text-gray-900 mb-4 uppercase">Compra rápida</h3>
            ...
            <div className="bg-[#F5F5F5] p-8 rounded-3xl text-center hover:-translate-y-2 transition-transform duration-300 shadow-lg border border-gray-100">
              ...
              <h3 className="font-poppins font-bold text-xl text-gray-900 mb-4 uppercase">Exclusivo empleados</h3>
